...
namespace App\Tests\Controller\Produit;
...
final class CategorieControllerTest extends WebTestCase
{
    ...
    private string $path = '/produit/categorie/';
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'categorie[parent]' => 'Something New',
        ]);

        self::assertResponseRedirects('/produit/categorie/');
