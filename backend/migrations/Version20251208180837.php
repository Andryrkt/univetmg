 ...
 */
final class Version20251208180837 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL');
        $this->addSql('ALTER TABLE produit ADD updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL');
