...
class AjustementType extends AbstractType
{
        ...
        $builder
            ...
            ->add('lot', EntityType::class, [
                ...
                'choice_label' => function (Lot $lot) {
                    return sprintf('%s (Stock actuel: %s)', $lot->getNumeroLot() ?: 'Sans numéro', $lot->getQuantite());
                },
                'label' => 'Lot *',
            ...
            ->add('nouvelleQuantite', NumberType::class, [
                'required' => true,
